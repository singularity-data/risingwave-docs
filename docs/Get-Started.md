...
You can install and run RisingWave from a Docker image on x64 systems. Images for ARM64 systems (including macOS devices with Apple M1 chips) might be available for testing purpose, but it is not guaranteed.
